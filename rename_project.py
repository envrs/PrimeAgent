...
IGNORE_DIRS = {'.git', '.idea', '.vscode', '__pycache__', 'node_modules', 'dist', 'build', 'bin', 'obj', '.svn', '.hg'}
IGNORE_EXTENSIONS = {'.png', '.jpg', '.jpeg', '.gif', '.ico', '.exe', '.dll', '.so', '.dylib', '.zip', '.tar', '.gz', '.pdf', '.pyc'}
...
def main():
    ...
    parser.add_argument("--old", required=True, help="The old project name (e.g., PrimeAgent)")
    parser.add_argument("--new", required=True, help="The new project name (e.g., TurboBot)")
